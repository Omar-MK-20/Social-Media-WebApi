...
export const REDIS_URL = process.env.REDIS_LOCAL_URL ? process.env.REDIS_LOCAL_URL : process.env.REDIS_REMOTE_URL as string;
...
export const EXPRESS_SESSION_KEY = process.env.EXPRESS_SESSION_KEY as string;